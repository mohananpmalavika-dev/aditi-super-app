    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 rounded-3xl bg-slate-900/80 border border-slate-800 shadow-xl">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-emerald-500 via-teal-600 to-cyan-500 flex items-center justify-center text-white shadow-lg shadow-emerald-500/25">
            <GraduationCap className="w-6 h-6" />
          </div>
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-xl sm:text-2xl font-extrabold text-white">Tutor & Skill Academy</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {filteredTutors.map((t) => (
          <div
            key={t.id}
            className="p-5 rounded-3xl bg-slate-900 border border-slate-800 hover:border-emerald-500/40 shadow-xl group transition-all flex flex-col justify-between"
          >
            <div className="space-y-4">
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">{t.education}</p>
                    <div className="flex items-center gap-2 text-[11px] font-bold text-amber-400 mt-0.5">
                      <span>⭐ {t.rating} ({t.reviewCount} reviews)</span>
                      <span className="text-slate-500">•</span>
                      <span className="text-slate-400">{t.studentsTaught}+ students taught</span>
                    </div>
                  </div>
                </div>

                <div className="text-right">
                  <span className="text-lg font-black text-emerald-400">${t.hourlyRate}</span>
              ...
              <div className="flex items-center gap-2 text-xs text-slate-400 pt-1">
                ...
                <span>Available: {t.availableDays.join(', ')}</span>
              </div>
            ...
            <div className="pt-4 mt-4 border-t border-slate-800 flex items-center gap-2">
              <button
                ...
                className="flex-1 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold transition-all shadow-md shadow-emerald-500/20 flex items-center justify-center gap-1.5"
              >
          ...
          <div className="w-full max-w-md max-h-[90dvh] overflow-y-auto rounded-3xl bg-slate-900 border border-slate-800 shadow-2xl p-6 space-y-4 my-auto">
            ...
            <div className="p-3 rounded-2xl bg-slate-950 border border-slate-800 flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-[11px] text-slate-400">{selectedTutor.education}</p>

      ...
      <div className="w-full max-w-4xl relative z-10 space-y-6 my-auto py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
          ...
          <div className="md:col-span-7 p-6 sm:p-7 rounded-3xl bg-slate-900/80 border border-slate-800 shadow-2xl backdrop-blur-xl space-y-5">
            ...
            {/* Instant Google Confirmation Badge */}
            <div className="p-2.5 rounded-2xl bg-indigo-950/60 border border-indigo-500/30 flex items-center gap-2.5 text-indigo-200 text-xs font-semibold">
              <span className="text-base">⚡</span>
              <span>No email confirmation required — verify and sign in instantly with Google Authentication.</span>
            </div>
            ...
            {authMode === 'signin' && (
              <form onSubmit={handleLoginSubmit} className="space-y-4 pt-1 animate-in fade-in">
                ...
                <button
                  ...
                  className="w-full py-3 px-4 rounded-xl bg-white hover:bg-slate-100 text-slate-900 font-extrabold text-xs flex items-center justify-center gap-2.5 shadow-md hover:scale-[1.01] active:scale-95 transition-all border border-slate-200"
                >
                  ...
                  <span>Confirm with Google Authentication (Instant)</span>
                </button>
              </form>
            )}
            ...
            {authMode === 'signup' && (
              <form onSubmit={handleRegisterSubmit} className="space-y-4 pt-1 animate-in fade-in">
                ...
                >
                  ...
                  <span>Confirm with Google Authentication (No Email Confirmation)</span>
                </button>
              </form>
            )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-xl p-4 animate-in fade-in">
          <div className="relative w-full max-w-md bg-white text-slate-900 rounded-3xl p-6 shadow-2xl space-y-5 animate-in zoom-in-95">
            ...
            <div className="text-center space-y-2">
              ...
              <h3 className="font-extrabold text-lg text-slate-900">Confirm with Google Authentication</h3>
              <p className="text-xs text-slate-500">Instant verification with your Google account • No email link confirmation needed</p>
            </div>

            {/* Direct 1-Click Google OAuth Trigger */}
            <button
              type="button"
              onClick={async () => {
                setLoading(true);
              ...
              className="w-full py-3 px-4 rounded-2xl bg-slate-50 hover:bg-slate-100 border border-slate-300 text-slate-900 font-extrabold text-xs flex items-center justify-center gap-3 shadow-sm hover:scale-[1.01] active:scale-95 transition-all"
            >
              ...
              <span>1-Click Continue with Google Account</span>
            </button>

            <div className="relative flex py-0.5 items-center">
              <div className="flex-grow border-t border-slate-200"></div>
              <span className="flex-shrink mx-3 text-[10px] text-slate-400 font-bold uppercase tracking-wider">or confirm via Gmail address</span>
              <div className="flex-grow border-t border-slate-200"></div>
            </div>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                >
                  ...
                  <span>Confirm with Google & Sign In (Instant)</span>
                </button>
              </form>
            </div>
